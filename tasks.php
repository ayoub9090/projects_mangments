		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-md-2  text-right">
					<button type="button" id="addTask" class="btn btn-info add" title="Add task"><span class="glyphicon glyphicon-plus"></span></button>
				</div>
			</div>
		</div>
		<table id="taskListing" class="table table-bordered table-striped table-hover">
			<thead>
				<tr>
					<th>#</th>
