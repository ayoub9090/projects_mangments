		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-md-2  text-right" >
					<button type="button" id="addProject" class="btn btn-info add" title="Add project"><span class="glyphicon glyphicon-plus"></span></button>
				</div>
			</div>
		</div>
		<table id="projectListing" class="table table-bordered table-striped table-hover">
			<thead>
				<tr>
					<th>#</th>
